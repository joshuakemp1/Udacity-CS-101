...
#replaced = I will now go to sleep and be away from keyboard until lunch time tomorrow.
...
marker = 'YDD'
replacement = "yabba dabba do!!!"
line = 'I want to go bowling with Fred Flinstone and Wilma and yell YDD... that would be fun!'
#replaced = I want to go bowling with Fred Flinstone and Wilma and yell yabba dabba do!!!... that would be fun!
replaced = line.sub(marker,replacement)
